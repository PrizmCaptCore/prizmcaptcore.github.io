...
Features RAG integration, 4-bit quantization, and modular architecture. Designed for use cases like NPC dialogue generation in games using fine-tuned language models.
